...
function Agence() {
  ...
  return (
    <>
      ...
      <div className='section-1 py-1 relative'>
        <img
          ref={imgDivRef}
          className='absolute bg-gray-500 overflow-hidden w-[14.5vw] h-[45vh] rounded-[2vw] top-0 left-[30vw] object-cover'
          src={agencyHeroImg}
          alt=""
        />
        <div className='font-[font500] relative mt-[55vh] text-center'>
          <h1 className='text-[20vw] leading-[17vw] uppercase'>Soixan7e Douze</h1>
          <p className='pl-[40%] text-[4.5vw] leading-[5vw] mt-10'>
            Notre curiosité nourrit notre créativité. On reste humbles et on dit non aux gros egos, même le vôtre.
            Une marque est vivante. Elle a des valeurs, une personnalité, une histoire. Si on oublie ça, on peut faire de bons chiffres à court terme, mais
            <br /> on la tue à long terme. C’est pour ça qu’on s’engage à donner de
            <br /> la perspective, pour bâtir des marques influentes.
          </p>
        </div>
      </div>
      ...
      {/* section 3 */}
      <div className='page-3 relative h-[100vw] w-screen overflow-x-hidden flex justify-center items-center'>
        <Marquee
        ...
        <div className='w-[32vw] h-[48vw] absolute '>
          <img src={img7} alt="" className='rounded-[2vw]' />
        </div>

        <div className='img-div2 absolute bottom-0 w-[32vw] h-[48vw]'>
          <img src={img7} alt="" className='rounded-[2vw]' />
        </div>
